              ...
              <div className="auth-inner py-2">
                ...
                <div className="card mb-0">
                  <div className="card-body">
                    ...
                    <p className="card-text mb-2">Please Register  to your account and start the adventure</p>
                    <form className="auth-login-form mt-2 text-left" onSubmit={useRegister}>
                      <div className="form-group">
                        <label htmlFor="login-email" className="form-label">Agency Name </label>
                        <input type="text" className="form-control" placeholder="Enter Agency Name" onChange={(e)=>setAgencyName(e.target.value)} value={agencyName}   required/>
                      </div>
                      
                      <div className="form-group">
                        <label htmlFor="login-email" className="form-label">UserName</label>
                        <input type="text" className="form-control" placeholder="Enter Username" onChange={(e)=>setUsername(e.target.value)} value={username}   required/>
                      </div>
                      ...
                      <div className="form-group">
                        <label htmlFor="login-email" className="form-label">Password</label>
                      ...
                      <div className="form-group">
                        <label htmlFor="login-email" className="form-label">Contact No</label>
                        <input type="text" className="form-control" placeholder="Enter Contact No" onChange={(e)=>setContactNo(e.target.value)} value={contactNo}   required/>
                      </div>
                      <div className="form-group">
                        <label htmlFor="login-email" className="form-label">Address</label>
                        <input type="text" className="form-control" placeholder="Enter Address" onChange={(e)=>setAddress(e.target.value)} value={address}   required/>
                      </div>
