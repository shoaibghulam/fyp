          ...
          <div className="navbar-container d-flex content">
            ...
            <ul className="nav navbar-nav align-items-center ml-auto">
              ...
              <li className="nav-item dropdown dropdown-user"><a className="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div className="user-nav d-sm-flex d-none"><span className="user-name font-weight-bolder">{ localStorage.getItem('Fullname')}</span><span className="user-status">Admin</span></div><span className="avatar"><img className="round" src="app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height={40} width={40} /><span className="avatar-status-online" /></span>
                </a>
            ...
            <ul className="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
              ...
              <li className=" nav-item">
                <Link className="d-flex align-items-center" to="/users">
                  <i data-feather="check-square" /><span className="menu-title text-truncate" data-i18n="user">User</span></Link>
              </li>
              <li className=" nav-item">
